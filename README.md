...
| Route            | What it shows                                                                                                                                                                                                                                                                                                                                                                                                                           |
| ---------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `/`              | Overview — daily/weekly summaries, running and needs-attention sessions, and a patterns section (calendar heatmap of the actual last 30 Eastern-time days, session-length histogram, week cost-at-a-glance). Cards link into filtered views.                                                                                                                                                                                            |
